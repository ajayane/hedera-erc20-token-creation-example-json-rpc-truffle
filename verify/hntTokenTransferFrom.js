...
const RECEIVER = '0x0426fe4685b20d597174e37594348ec6c1a38f3b'
const SIGNER = "0x4Cf2429328dA1381Ef5330E6c3aC52754C68A9bc";
...
async function transferTokens(client) {
    try {
        ...
        const tx = myToken.methods.transferFrom(HOLDER_ADDRESS, RECEIVER,transferAmount);
        const gas = await tx.estimateGas({from: HOLDER_ADDRESS});
        ...
        const hTxn = await new ContractExecuteTransaction()
            .setContractId(ContractId.fromString("0.0.4395649"))
